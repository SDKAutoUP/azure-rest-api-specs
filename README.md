...
This repository is the canonical source for REST API specifications for Microsoft Azure. test test test test test test test test test test test test test
